package net.sample.framework.message.push.bean;
...
public class GAGMessage<T> implements Serializable
{
    ...
    private String serial;//uuid 流水号
    ...
    private T data;//业务数据
    private byte[] binary;//业务数据，如文件private String 
    ...
    private long timeout = 259200000;//消息过期时间,毫秒  默认为3天
    private long ctime = System.currentTimeMillis();//消息创建时间，毫秒 默认
    ...
    {
        return "GAGMessage [serial=" + this.serial + ", receiveid=" + Arrays.toString(this.receiveid) + ", shopid=" + this.shopid + ", shopentityid=" + this.shopentityid + ", itype=" + this.itype + ", rpc=" + this.rpc + ", data=" + this.data + ", binary.size=" + (this.binary == null ? "0" : this.binary.length) + ", source=" + this.source + ", flag=" + this.flag + ", rsend=" + this.rsend + ", allpush=" + this.allpush + ", timeout=" + this.timeout + ", ctime=" + this.ctime + "]";
    }
