...
public class ResponseFuture implements Serializable
{
    ...
    {
        return "ResponseFuture [responseCommand=" + this.responseCommand + ", sendRequestOK=" + this.sendRequestOK + ", throwable=" + this.throwable + ", serial=" + this.serial + ", sendTimeoutMillis=" + this.sendTimeoutMillis + ", callback=" + this.callback + ", beginSendTime=" + this.beginSendTime + ", countDownLatch=" + this.countDownLatch + "]";
    }
