package net.sebinson.sample.demos.zookeeper;
...
public class JavaApiSample implements Watcher {
    ...
    private static final String CONNECTION_STRING  = "zk.sebinson.net:2181";
    private static final String ZK_PATH            = "/sebinson/sample";
