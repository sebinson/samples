 ...
 */
public class SessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent>
{
    ...
    private String environment = SessionFactoryBean.class.getSimpleName();
    ...
    {
        notNull(this.dataSource, "Property 'dataSource' is required");
        notNull(this.sqlSessionFactoryBuilder, "Property 'sqlSessionFactoryBuilder' is required");
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException
    {
        ...
        for (Resource configLocation : this.configLocations)
        {
            this.readXML(configLocation, elementTypeAlias, elementMapper);
        }
        // Reader reader = null; InputStream inputStream = null;
        if (this.configLocations != null)
        {
            this.logger.debug(document.asXML());
